...
const LearningGrid = () => {
  return (
    <div className="w-11/12 max-w-maxContent  sm:mx-auto grid grid-col-1 lg:grid-cols-4  lg:w-fit   mx-20">
      {LearningGridArray.map((card, index) => {
        return (
          ...
          >
            {card.order < 0 ? (
              <div className="lg:w-[90%] flex justify-start flex-col gap-2">
